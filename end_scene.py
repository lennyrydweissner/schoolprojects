...
class EndScene:
    ...
    def __init__(self, display_surface):
        ...
        text_two = "SPELET ÄR SLUT. TRYCK (A) FÖR ATT SPELA IGEN. ELLER TRYCK (E) FÖR ATT AVSLUTA SPELET HELT. "
    ...
    def show_the_end(self):
        ...
        self.text_one = font.render(self.text_one_output, True, GREEN2, BLACK)
        self.text_two = font_two.render(self.text_two_output, True, GREEN2, BLACK)
